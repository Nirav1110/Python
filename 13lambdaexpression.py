...
func = lambda a: True if len(a)>5 else False ##this is just for understading how we can write if else with lambda 
func2 = lambda a:len(a)>5 ###we can write above directly like this buut above is just for understaing how to write if else 